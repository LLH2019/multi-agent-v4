...
public class ReadTxt {
    public List<List<String>> readTxtData(int taskNum, int rapid) {
        ...
        try { // 防止文件建立或读取失败，用catch捕捉错误并打印，也可以throw
            ...
            /* 读入TXT文件 */
            String pathname =GlobalAkkaPara.dataPath +"write-with-cost-by"+ GlobalAkkaPara.resourceSize + "-" + (GlobalAkkaPara.taskSize*taskNum) +"-" + rapid +".txt"; // 绝对路径或相对路径都可以，这里是绝对路径，写入文件时演示相对路径
